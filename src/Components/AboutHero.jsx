  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1
            className="font-humane text-white text-center font-bold uppercase
            text-[60px] md:text-[90px] lg:text-[105px] scale-y-125"
            style={{
              lineHeight: "90%",
            }}
          >
        ...
        <div
          className="bg-[#1B2129] flex flex-col lg:flex-row items-center"
          style={{
            marginTop: "28px",
            padding: "36px",
            gap: "36px",
        ...
        >
          ...
          <div className="w-full lg:w-[62%] text-center lg:text-left">
            ...
            >
              <button
                className="flex items-center font-dm font-semibold hover:bg-[#D9FF2F] hover:text-[#121212] transition duration-300"
                style={{
                  padding: "14px 24px",
                  gap: "10px",
                  borderRadius: "8px",
